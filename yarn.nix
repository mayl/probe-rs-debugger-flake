{ fetchurl, fetchgit, linkFarm, runCommand, gnutar }: rec {
  ...
  packages = [
    ...
    {
      name = "await_notify___await_notify_1.0.1.tgz";
      path = fetchurl {
        name = "await_notify___await_notify_1.0.1.tgz";
        url  = "https://registry.yarnpkg.com/await-notify/-/await-notify-1.0.1.tgz";
        sha512 = "eT6XN2ycPKvuiffzUNmU0dnGmmLw+TexMW7UKOyf5utdVrWx14PR2acRIfy6ZfFWRAv8twt1X74VUgd9RnDmfQ==";
      };
    }
    {
